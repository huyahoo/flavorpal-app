<template>
  <div class="relative flex flex-grow items-center justify-center bg-black">
    ...
    <button
      ...
      class="absolute left-1/2 z-10 -translate-x-1/2 rounded-xl bg-red-600 px-8 py-3 text-base font-medium text-white shadow-lg transition-colors hover:bg-red-700"
