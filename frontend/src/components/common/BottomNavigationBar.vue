  ...
  <nav class="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-200 shadow-top-nav z-50">
    <div class="flex justify-around items-center h-16">
      ...
      <div class="flex-1 flex justify-center">
        <router-link
          to="/scan"
          class="flex flex-col items-center justify-center text-center -mt-5 transform transition-transform duration-200 ease-in-out hover:scale-110 active:scale-100"
          @click="handleNavigation('/scan')"
          aria-label="Scan Product"
        >
          <div class="bg-flavorpal-green text-white rounded-full p-4 shadow-lg ring-4 ring-white dark:ring-gray-50">
            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
          </div>
          <span class="text-xs font-medium tracking-tight mt-1" :class="isActive('/scan') ? 'text-flavorpal-green' : 'text-flavorpal-gray'">Scan</span>
        </router-link>
      </div>
